...
fn migrations() -> Vec<Migration> {
    vec![
        ...
        Migration {
            version: 2,
            description: "traffic_signs_dataset",
            sql: r#"
                CREATE TABLE IF NOT EXISTS traffic_sign_metadata (
                    key TEXT PRIMARY KEY NOT NULL,
                    value TEXT NOT NULL
                );
                ...
                CREATE INDEX IF NOT EXISTS idx_traffic_signs_group ON traffic_signs(group_code);
                CREATE INDEX IF NOT EXISTS idx_traffic_signs_name ON traffic_signs(name);
            "#,
            kind: MigrationKind::Up,
        },
    ]
